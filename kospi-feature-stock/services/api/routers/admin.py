...
async def data_quality(
    ...
    result = {
        ...
        "ml_confidence": {
            ...
            "opt_f1":              ml_metrics.get("opt_f1"),
            "opt_recall":          ml_metrics.get("opt_recall"),
            "opt_precision":       ml_metrics.get("opt_precision"),
            "trained_at":          ml_metrics.get("trained_at"),
            "model_age_days":      model_age_days,
            "feature_count":       ml_metrics.get("feature_count") or ml_metrics.get("n_features"),
            "train_samples":       ml_metrics.get("train_samples") or ml_metrics.get("n_train"),
