...
async def main(args):
    ...
    elif args.label_mode == "target_hit":
        logger.info("Generating labels (target_hit — high/low based +10%% target / -5%% stop)...")
    ...
    if optuna_trials > 0:
        logger.info(f"Running Optuna HPO ({optuna_trials} trials)...")
        best_params = trainer.optimize_hyperparams(Xtr_e, ytr_e, Xva_e, yva_e,
